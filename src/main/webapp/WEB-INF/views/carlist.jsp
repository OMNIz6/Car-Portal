...
<body>
	...
	<section class="content row">
		...
		<!-- car section of the main content -->
			<div class="car-con">
			<h2 class="car-header text-center">Cars </h2>
				<%@include file = "component/cardisplay.jsp" %>
			<c:if test="${not empty Apps }">
				<h2 class="car-header text-center">Appointments </h2>
					<%@include file = "component/AppDisplay.jsp" %>
			</c:if>
			</div>
		...
		<!-- sub section of the main content -->
			<div class="sub-con">
				...
				<%@include file = "component/postcarform.jsp" %>
			</div>
		</div>
