...
<body>
	...
	<section class="content row">
		...
		<div class="main row col-10">

		<!-- car section of the main content -->
			<div class="car-con" style="margin: 0;">
				<%@include file = "component/detail.jsp" %>
			</div>
			<div class="seperator"></div>

		<!-- sub section of the main content -->
			<div class="sub-con">
				<%@include file = "component/search.jsp" %>
				<c:if test="${owner == true }">
					<c:if test="${detail.status != 'Appointed'}">
						<%@include file = "component/bidlist.jsp" %>
					</c:if>
					<c:if test="${detail.status == 'Appointed'}">
						<%@include file = "component/appointmentlist.jsp" %>
					</c:if>
				</c:if>
				<c:if test="${owner == false }"><%@include file = "component/postcarform.jsp" %></c:if>
